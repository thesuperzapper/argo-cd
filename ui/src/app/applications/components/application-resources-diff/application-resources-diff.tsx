        ...
        {pref => {
            ...
            props.states
                .map(state => {
                    ...
                    return {
                        a: normalizedLiveState ? jsYaml.dump(normalizedLiveState, {indent: 2}) : '',
                        b: predictedLiveState ? jsYaml.dump(predictedLiveState, {indent: 2}) : '',
                        hook: state.hook,
                ...
                .forEach(i => {
                    ...
                    // changes, which is a more readable format for the user
                    const [file] = parseDiff(gitDiff, {nearbySequences: 'zip'});
            ...
            //
            // TODO: remove this if we cant think of a way to "uncollapse all" within the diff viewer
            //
            const compactDiff = pref.appDetails.compactDiff;
